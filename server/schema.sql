...
CREATE TABLE IF NOT EXISTS jogadores (
  ...
  numero_camisa INT NOT NULL DEFAULT 0,
  foto_url TEXT,
...
ALTER TABLE jogadores ADD COLUMN IF NOT EXISTS posicao TEXT NOT NULL DEFAULT '';
ALTER TABLE jogadores ADD COLUMN IF NOT EXISTS numero_camisa INT NOT NULL DEFAULT 0;
ALTER TABLE jogadores ADD COLUMN IF NOT EXISTS foto_url TEXT;
ALTER TABLE jogadores ADD COLUMN IF NOT EXISTS assistencias INT NOT NULL DEFAULT 0;
ALTER TABLE jogadores ADD COLUMN IF NOT EXISTS jogos INT NOT NULL DEFAULT 0;
